...
def getMessage(un_file):
    ...
    for file in files:
        ...
        f.close()
    map_TC.append([year, start_time, end_time, min_lat, max_lat, min_lon, max_lon])
...
if __name__ == '__main__':
    col_name = ['year', 'start_time', 'end_start', 'min_lat', 'max_lat', 'min_lon', 'max_lon']
    i = 0
    ...
    map_tc.to_csv('D:\my_data_set\map_TC.csv', encoding='gbk')
